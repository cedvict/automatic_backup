...
{
    "name" : "Database Automatic-Backup",
    "version" : "1.1",
    "author" : "Artarad",
    "website" : "http://www.artarad.com",
    "category" : "Generic Modules",
    "summary": "Backups",
    "description": """The Database automatic_backup module enables the user to make configurations for the automatic backup of the database. Backups can be taken on the local system or on a remote server, through SFTP.
...
The base of this module is taken from Odoo SA V6.1 (https://www.odoo.com/apps/modules/6.0/automatic_backup/) and then upgraded and heavily expanded.
